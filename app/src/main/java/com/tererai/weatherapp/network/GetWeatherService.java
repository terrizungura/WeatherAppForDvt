...
public interface GetWeatherService {
    ...
    @GET("weather/")
    Call<CurrentWeather> getWeatherCurrent(@Query("appid") String appid, @Query("lon") String longitude,
                                           @Query("lat") String latitude);

    @GET("weather/")
    Call<CurrentWeather> getWeatherCurrentForCity(@Query("appid") String appid, @Query("q") String city);
